                ...
                <div class="col-md-12 col-sm-12">
                    <div class="single-blog-wrap">
                       <div class="b-item-detail">
                            ...
                            <p>Thank you for visiting My Develop Center. This page will provide you with details about how we use the personal information collected at this site. Privacy policy must be read before using the site or submitting any personal information.</br>
                            <b>Note:</b> The privacy practices that are stated in the privacy policy are for My Develop Center website only. No third-party website can be linked with this website.</br>
                            Following are the privacy practices used by My Develop Center:</p>
                            ...
                            <h5 class="color-black f-w-500">We may do so when:</h5>
                            <ol>
